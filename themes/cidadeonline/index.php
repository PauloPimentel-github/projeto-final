    ...
    <section class="main-destaques">
        ...
        <aside>
            <div class="aside-banner">
                <!--300x250-->
                <a href="http://www.cruzeirodosul.edu.br/" title="Universidade Cruzeiro do Sul - Cursos Profissionais em TI">
                    <img src="<?= INCLUDE_PATH; ?>/_tmp/banner_unicsul.png" title="Campus UpInside - Cursos Profissionais em TI" alt="Campus UpInside - Cursos Profissionais em TI" />
                </a>
            </div>
        ...
        <section class="baladas">
            ...
            <div class="last_news">
                ...
                if (!$post->getResult()):
                    ...
                    foreach ($post->getResult() as $news):
                        $news['post_title'] = Check::Words($news['post_title'], 12);
                        $news['post_content'] = Check::Words($new['post_content'], 20);
                        $news['datetime'] = date('Y-m-d', strtotime($news['post_date']));
                        $news['pubdate'] = date('d/m/Y H:i', strtotime($news['post_date']));
                        $View->Show($news, $tpl_p);
                    endforeach;
