        ...
        <form name="PostForm" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="label_line">
                <label class="label_medium">
                    ...
                    <input type="url" placeholder="http://www.tgi1.com.br" name="empresa_site" value="<?php if (isset($data['empresa_site'])) echo htmlspecialchars($data['empresa_site']); ?>" />
                </label>

                <label class="label_medium">
                    <span class="field">Facebook Page:</span>
                    <input type="text" placeholder="https://pt-br.facebook.com/acruzeirodosul/" name="empresa_facebook" value="<?php if (isset($data['empresa_facebook'])) echo htmlspecialchars($data['empresa_facebook']); ?>" />
                </label>                
            </div><!-- line -->
            ...
            <input type="submit" class="btn" value="Cadastrar Empresa" name="SendPostForm" />
