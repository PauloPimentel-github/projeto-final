...
<html lang="pt-BR">
    <head>
        ...
        <meta name="description" content="Esse site foi produzido por: Paulo Pimentel. Aluno Upinside">
        <meta name="author" content="Paulo Pimentel">
        ...
        <div class="site-container">
            ...
            <section class="main-destaques">
                ...
                <aside>
                    <div class="aside-banner">
                        <!--300x250-->
                        <a href="http://www.cruzeirodosul.com.br" title="Cursos Profissionais em TI">
                            <img src="_tmp/banner_unicsul.png.png" title="Cursos Profissionais em TI" alt="Cursos Profissionais em TI" />
                        </a>
                    </div>
            ...
            <section class="last_forcat">
                ...
                <section class="baladas">
                    <h2 class="line_title"><span class="azul">Aconteceu:</span></h2>
